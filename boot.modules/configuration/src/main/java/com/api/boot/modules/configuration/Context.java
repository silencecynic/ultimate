...
public class Context {
    ...
    @Bean (name = "fixedLocaleResolver" )
    public LocaleResolver fixedLocaleResolver() {
        FixedLocaleResolver fixedLocaleResolver = new FixedLocaleResolver();
        fixedLocaleResolver.setDefaultLocale(Locale.SIMPLIFIED_CHINESE);
    ...
    public MessageSource messageSource() {
        ...
        bundleMessageSource.setBasenames("in18/zh_CN","in18/en_US","in18/validate");
